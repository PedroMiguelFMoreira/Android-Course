...
public class MyArrayAdapter extends ArrayAdapter<Contacts.FriendInfo> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Picasso.with(context).load(Constants.SERVER + friendInfoList.get(position).imageURL).placeholder(R.mipmap.ic_launcher).error(R.mipmap.ic_launcher).resize(50, 50).centerCrop().into(imageView);
